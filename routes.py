...
from controller_functions import home, add_user, homepage, login, logout, new, addnew, new_attendee, event, create_msg#importing all the functions associated with the routes we're writing
