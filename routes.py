...
from controller_functions import home, add_user, homepage, login, logout, new, addnew, new_attendee, notifications#importing all the functions associated with the routes we're writing
...
app.add_url_rule("/notifications", view_func=notifications)